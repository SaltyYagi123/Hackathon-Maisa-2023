...
class Noticias(models.Model):
    title = models.CharField(max_length=250, verbose_name='Título')  #TITULO
    excerpt = models.TextField(verbose_name='Bajada')    #RESUMEN
    content = RichTextField(verbose_name='Contenido')    #CONTENIDO, TODA LA NOTICIA
...
class Noticias2(models.Model):
    ...
    class Meta:
        verbose_name = 'Noticia2'
        verbose_name_plural = 'Noticias2'
        ordering = ['title']
...
class Factifys(models.Model):
    ...
    resume = models.TextField()  # Agrega una coma aquí
